...
import com.example.stravaver1.utils.SingleLiveEvent
...
class OauthViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun onAuthCodeFailed(exception: AuthorizationException) {
        toastLiveEvent.postValue(R.string.authCodeFailed)
    }
    ...
    fun onAuthCodeReceived(tokenRequest: TokenRequest) {
        ...
        authRepository.performTokenRequest(
            ...
            onError = {
                loadingMutableLiveData.postValue(false)
                toastLiveEvent.postValue(R.string.push)
            }
        )
    }
    ...
    fun openLoginPage() {
        ...
        val customTabsIntent = CustomTabsIntent.Builder()
            .setToolbarColor(ContextCompat.getColor(getApplication(), R.color.lilu))
            .build()
